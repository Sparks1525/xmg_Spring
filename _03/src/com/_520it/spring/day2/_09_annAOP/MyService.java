package com._520it.spring.day2._09_annAOP;
...
public class MyService {
    ...
    /**
     * 申明一个pointcut
     * <_07_aop:pointcut expression="execution(* com._520it.spring.day2._08_aspect.SomeBean.*(..))" id="pc"/>
     */
    @Pointcut("execution(* com._520it.spring.day2._09_annAOP.SomeBean.*(..))")
    public void pc(){}

    /**
     * <_07_aop:before method="before"
     * 1,可以直接写point-cut表达式
     * 2,使用定义好的pointcut
     */
    @Before("pc()")
